      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4">
          ...
          <p className="text-lg md:text-xl mb-6">
            Music concerts, theatre shows, workshops, festivals all in one
            place!
          </p>
          <Link
            to="/events"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-[90%] max-w-md text-center animate-scaleIn">
              ...
              <p className="text-gray-600 mb-6">
                The <span className="font-semibold">Add Event</span> feature is
                currently under development. You can contact us to add your
                event now.. Stay tuned!
              </p>
